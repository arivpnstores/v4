...
## FIX SSL CERTIVICATE UNIVERSAL
```bash
wget -O restore-universal.sh https://raw.githubusercontent.com/arivpnstores/v4/main/fix-add-ssl.sh && chmod +x fix-add-ssl.sh && ./fix-add-ssl.sh
```
